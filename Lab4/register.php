			...
			<p><label for="user_login">Повне ім'я<br>
				...
				<p><label for="user_pass">E-mail<br>
					...
					<p><label for="user_pass">Ім'я користувача<br>
						...
						<p><label for="user_pass">Пароль<br>
							...
							<p class="submit"><input class="button" id="register" name= "register" type="submit" value="Зареєструвати"></p>
				...
				if(isset($_POST["register"])){
					...
					if(!empty($_POST['full_name']) && !empty($_POST['email']) && !empty($_POST['username']) && !empty($_POST['password'])) {
						...
						$query=mysqli_query($con, "SELECT * FROM User_klient WHERE username='".$username."'");
